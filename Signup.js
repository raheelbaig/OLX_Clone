...
import { addData, SignUp } from '../config/firebase';
...
function Signup({ setChangeScreenCreateAdd }) {
  ...
  return (
    <div className='signup_form'>
      ...
      <div className='Signup_form_right'>
        <h1>Sign Up</h1>
        <input placeholder='Enter your Name' onChange={(e) => setName(e.target.value)} /><br />
        ...
        <Button variant="outline-primary" onClick={signup} type="submit">Submit</Button>
        <Button variant="outline-primary" onClick={loginPage}>Login</Button>
      </div>
    </div>
  )
}
